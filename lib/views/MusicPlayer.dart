...
import 'package:flutter_music/constants/colors.dart';
import 'package:flutter_music/constants/strings.dart';
import 'package:flutter_music/models/music.dart';
import 'package:flutter_music/views/lyricsPages.dart';
import 'package:flutter_music/views/widgets/art_work_image.dart';
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  Music music = Music(trackId: '5QhJorJmjqYfETfqgBtGg3');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        final video =
            (await yt.search.search("$tempSongName ${music.artistName ?? ""} lyrics"))
                .first;
          ...
          child: Column(
            children: [
              ...
              Expanded(
                  flex: 2,
                  child: Center(
                    child: ArtWorkImage(image: music.songImage ?? 'no image'),
                  )),
              Expanded(
                  child: Column(
                children: [
